export const places = [
    ...
    {
        "name": "Mason Area Historical Museum",
    ...
    {
        "name": "Historical Ingham County Courthouse",
    ...
    {
        "name": "Michigan Steam Engine and Threshers Club",
